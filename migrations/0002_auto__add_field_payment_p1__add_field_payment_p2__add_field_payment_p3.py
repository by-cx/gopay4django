...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('gopay_payment', 'p1',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Payment.p2'
        db.add_column('gopay_payment', 'p2',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Payment.p3'
        db.add_column('gopay_payment', 'p3',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Payment.p4'
        db.add_column('gopay_payment', 'p4',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('gopay_payment', 'p1')

        # Deleting field 'Payment.p2'
        db.delete_column('gopay_payment', 'p2')

        # Deleting field 'Payment.p3'
        db.delete_column('gopay_payment', 'p3')

        # Deleting field 'Payment.p4'
        db.delete_column('gopay_payment', 'p4')
